...
export function ServiceCard({ service, size = 'small', index, className }: ServiceCardProps) {
  ...
  const sizeClasses = {
    large: 'col-span-1 lg:col-span-2 min-h-[240px] sm:min-h-[280px] md:min-h-[380px]',
    medium: 'col-span-1 min-h-[240px] sm:min-h-[280px] md:min-h-[380px]',
    small: 'col-span-1 min-h-[220px] sm:min-h-[260px] md:min-h-[320px]',
  }
