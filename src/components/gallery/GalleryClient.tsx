...
const GALLERY_ITEMS = [
  ...
  { id: 10, src: '/images/servizi/lavaggio-pulizia-pannelli-fotovoltaici-parma.png', alt: 'Operazione di lavaggio professionale per pannelli fotovoltaici a Parma e provincia', label: 'Pannelli Fotovoltaici', category: 'speciali', span: 'col-span-1 row-span-1' },
  ...
  { id: 12, src: '/images/servizi/pulizie-settore-alberghiero-hotel-bed-breakfast-parma.png', alt: 'Servizio di pulizia e riassetto camere per hotel e strutture ricettive a Parma', label: 'Settore Alberghiero', category: 'aziendali', span: 'col-span-2 row-span-1' },
  ...
  { id: 17, src: '/images/flotta-furgoni-impresa-pulizie-parma.webp', alt: "La flotta di Fulgur Service — furgoni moderni e attrezzati sempre pronti all'intervento a Parma", label: 'La Nostra Flotta', category: 'azienda', span: 'col-span-1 row-span-1' },
  ...
  { id: 22, src: '/images/gallery/operatori-squadra-pulizie-fulgur-service.png', alt: 'La squadra operativa Fulgur Service impiegata in un intervento strutturato', label: 'Il Nostro Team', category: 'azienda', span: 'col-span-1 row-span-1' },
