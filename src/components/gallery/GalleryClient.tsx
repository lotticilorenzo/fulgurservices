...
const GALLERY_ITEMS = [
  ...
  { id: 10, src: '/images/servizi/pulizia-pannelli-fotovoltaici-parma.png', alt: 'Pulizia pannelli fotovoltaici impianti solari Parma — Fulgur Service', label: 'Pannelli Fotovoltaici', category: 'speciali', span: 'col-span-1 row-span-1' },
  ...
  { id: 12, src: '/images/servizi/pulizie-hotel-alberghi-parma.png', alt: 'Pulizie hotel alberghi settore alberghiero a Parma — Fulgur Service', label: 'Settore Alberghiero', category: 'aziendali', span: 'col-span-2 row-span-1' },
  ...
  { id: 21, src: '/images/gallery/gallery-project-3.jpg', alt: 'Prima e Dopo Pavimenti', label: 'Prima E Dopo', category: 'aziendali', span: 'col-span-1 row-span-1' },
  { id: 22, src: '/images/gallery/gallery-project-4.png', alt: 'Team Operativo Fulgur Service', label: 'Il Nostro Team', category: 'azienda', span: 'col-span-1 row-span-1' },
  { id: 23, src: '/images/gallery/gallery-project-5.jpg', alt: 'Intervento in alta quota e vetrate', label: 'Lavori In Quota', category: 'speciali', span: 'col-span-1 row-span-2' },
  { id: 24, src: '/images/gallery/gallery-project-6.jpg', alt: 'Macchinari e attrezzature pulizie parma', label: 'Intervento Professionale', category: 'aziendali', span: 'col-span-1 row-span-1' },
  { id: 25, src: '/images/gallery/gallery-project-7.jpg', alt: 'Pulizie industriali pavimentazione e magazzini', label: 'Pavimentazioni', category: 'industriali', span: 'col-span-1 row-span-1' },
  { id: 26, src: '/images/gallery/gallery-project-8.jpg', alt: 'Risultato pulizia a fondo superfici', label: 'Riserve e Dettagli', category: 'residenziali', span: 'col-span-1 row-span-1' },
  { id: 27, src: '/images/gallery/gallery-project-9.jpg', alt: 'Risultati perfetti negli ambienti di lavoro', label: 'Uffici', category: 'aziendali', span: 'col-span-1 row-span-1' },
  { id: 28, src: '/images/gallery/gallery-project-10.jpg', alt: 'Cura e manutenzione condomini', label: 'Intervento in Condominio', category: 'residenziali', span: 'col-span-1 row-span-1' },
  { id: 29, src: '/images/gallery/gallery-project-11.jpg', alt: 'Sanificazione e trattamenti specifici', label: 'Igiene Profonda', category: 'speciali', span: 'col-span-1 row-span-1' },
  { id: 30, src: '/images/gallery/gallery-project-12.jpg', alt: 'Pulizie di fino post cantiere', label: 'Fine Cantiere', category: 'speciali', span: 'col-span-1 row-span-1' },
]
