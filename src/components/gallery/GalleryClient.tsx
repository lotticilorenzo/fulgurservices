...
const GALLERY_ITEMS = [
  ...
  { id: 10, src: '/images/servizi/pannelli-fotovoltaici.jpeg', alt: 'Operazione di lavaggio professionale per pannelli fotovoltaici a Parma e provincia', label: 'Pannelli Fotovoltaici', category: 'speciali', span: 'col-span-1 row-span-1' },
  ...
  { id: 13, src: '/images/macchinari-pulizie-professionali.jpg', alt: 'Pulizia professionale di un salone elegante a Parma — Fulgur Service', label: 'Pulizia salone', category: 'azienda', span: 'col-span-1 row-span-1' },
  ...
  { id: 16, src: '/images/servizi/pulizie-palestre-strutture-sportive-parma.jpg', alt: 'Pulizia professionale di un ufficio moderno a Parma — Fulgur Service', label: 'Pulizia uffici', category: 'industriali', span: 'col-span-1 row-span-1' },
  ...
  { id: 23, src: '/images/gallery/pulizia-vetrate-in-quota-piattaforma-parma.jpg', alt: 'Intervento di pulizia profonda e lavaggio mattonelle esterne con monospazzola — Fulgur Service', label: 'Pulizia mattonelle', category: 'speciali', span: 'col-span-1 row-span-2' },
  { id: 24, src: '/images/gallery/macchinari-pulizia-professionale-industriale.jpg', alt: 'Intervento di pulizia di fondo dopo lavori di ristrutturazione — Fulgur Service', label: 'Pulizia post ristrutturazione', category: 'aziendali', span: 'col-span-1 row-span-1' },
  ...
  { id: 29, src: '/images/gallery/sanificazione-vapore-ambienti-sensibili.jpg', alt: 'Pulizia professionale di facciate con sistemi ad acqua pura e aste telescopiche — Fulgur Service', label: 'Pulizia facciate', category: 'speciali', span: 'col-span-1 row-span-1' },
  { id: 30, src: '/images/gallery/pulizia-post-cantiere-nuova-costruzione.jpg', alt: 'Pulizia professionale di facciate in pietra e mattoni a vista — Fulgur Service', label: 'Pulizia facciate', category: 'speciali', span: 'col-span-1 row-span-1' },
  ...
  { id: 69, src: '/images/gallery/pulizia-locale-commerciale-operatore-fulgur.jpg', alt: 'Il nostro furgone operativo durante un intervento in centro storico a Parma — Fulgur Service', label: 'In giro per la città', category: 'aziendali', span: 'col-span-1 row-span-2' },
  ...
  { id: 72, src: '/images/gallery/terrazzo-cotto-pulito-villa-fulgur-1.jpg', alt: 'Intervento di pulizia professionale in un locale commerciale di pregio — Fulgur Service', label: 'Pulizia professionale', category: 'residenziali', span: 'col-span-1 row-span-1' },
