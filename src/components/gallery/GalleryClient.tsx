...
const GALLERY_ITEMS = [
  ...
  { id: 59, src: '/images/gallery/auto-fulgur-service-sede-uffici.jpg', alt: 'Auto aziendale Jeep Fulgur Service con logo parcheggiata davanti a un edificio operativo', label: 'La Nostra Sede', category: 'azienda', span: 'col-span-1 row-span-1' },
