...
const STEP_SERVIZI = [
  ...
  { id: 'settore-sanitario', label: 'Settore Sanitario', icon: '🏥' },
  { id: 'fine-cantiere',    label: 'Fine Cantiere',     icon: '🔨' },
...
const WaIcon = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className={className || "w-[26px] h-[26px]"}>
        ...
        {visible && (
          ...
          >
            ...
            <motion.button
              ...
              className="group hidden sm:flex pointer-events-auto items-center gap-2.5 rounded-full bg-[var(--accent)] px-4 py-3 shadow-[0_8px_28px_rgba(78,203,160,0.4)] transition-all hover:bg-[var(--accent-d)] hover:shadow-[0_10px_36px_rgba(78,203,160,0.5)] hover:gap-3"
            >
              {/* Lightning icon */}
