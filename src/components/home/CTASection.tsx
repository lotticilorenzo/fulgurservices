...
export function CTASection() {
  return (
    <section
      id="contatti"
      className="relative flex w-full items-center justify-center overflow-hidden py-16 sm:py-24 lg:py-32 xl:py-36 px-6 border-t border-[var(--br)]"
    >
...
<div className="relative z-10 mx-auto w-full max-w-4xl text-center">
        ...
        <ScrollReveal delay={0.15} className="mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row">
          ...
          <a
            ...
            className="flex h-16 items-center gap-2.5 rounded-full border border-[var(--br-h)] bg-white px-8 font-display text-[15px] font-bold text-[var(--tx-1)] shadow-sm transition-all hover:border-[var(--accent)] hover:shadow-md w-full sm:w-auto justify-center"
          >
        ...
        <ScrollReveal delay={0.25}>
          <div className="mt-8 sm:mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-8 font-mono-fulgur text-[11px] sm:text-[12px] text-[var(--tx-3)]">
            ...
            <a href="mailto:fulgurservice@gmail.com" className="flex items-center gap-2 hover:text-[var(--accent)] transition-colors">
