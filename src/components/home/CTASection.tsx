...
export function CTASection() {
  return (
    ...
    >
      ...
      {/* Overlay bianco semitrasparente — mantiene leggibilità e brand chiaro (incrementato su mobile per maggiore contrasto) */}
      <div
        aria-hidden="true"
        className="absolute inset-0 pointer-events-none bg-[rgba(247,251,250,0.88)] sm:bg-[rgba(247,251,250,0.78)]"
      />
