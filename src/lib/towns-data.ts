...
export const TOWNS: Town[] = [
  {
    ...
    description: 'Fulgur Service opera a Fidenza offrendo soluzioni di pulizia certificate per il settore commerciale e terziario. La nostra vicinanza ci permette interventi rapidi e sopralluoghi gratuiti in 24 ore.',
    metaTitle: 'Impresa di Pulizie Fidenza | Uffici e Negozi — Fulgur Service',
    metaDescription: 'Cerchi un\'impresa di pulizie a Fidenza? Fulgur Service offre pulizie professionali per uffici, negozi e condomini a Fidenza. Sopralluogo gratuito in 24h.',
    keySector: 'Settore Commerciale & Outlet',
    keyBenefit: 'Pronto Intervento 24h',
  },
  {
