...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'ditta pulizie Parma',
    'pulizie uffici Parma',
    'pulizie industriali Parma',
    'sanificazione ambienti Parma',
    'pulizie condomini Parma',
    'impresa pulizie Italia',
    'pulizie professionali Italia',
  ],
  ...
  openGraph: {
    ...
    images: [
      {
        url: '/images/team-operatori-pulizie-professionali-parma.webp',
        width: 1200,
        height: 630,
      },
    ],
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-WDRW6HGV');`}
      </Script>
      <head>
        <script
      ...
      >
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-WDRW6HGV"
            height="0"
            width="0"
