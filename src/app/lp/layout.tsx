  ...
  return (
    <>
      ...
      */}
      ...
      {/* WhatsApp sticky — mobile only. bottom-20 per stare sopra LPStickyBar (64px) */}
      <a
        href="https://wa.me/393383160091?text=Ciao%2C%20ho%20visto%20le%20vostre%20landing%20page"
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Contattaci su WhatsApp"
        className="fixed bottom-20 right-4 z-50 md:hidden w-14 h-14 rounded-full bg-[#25D366] flex items-center justify-center shadow-lg hover:scale-110 transition-transform"
      >
        <WhatsappLogo weight="fill" size={28} className="text-white" aria-hidden="true" />
      </a>
      <LPStickyBar phoneRaw="+393383160091" />
    </>
  )
}
