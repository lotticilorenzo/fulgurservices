...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/storage`,            lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${baseUrl}/lavora-con-noi`,     lastModified: new Date(), changeFrequency: 'yearly',  priority: 0.6 },
    { url: `${baseUrl}/zone`,               lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
